...
namespace IMS.Plugins.EfCoreSqlServer
{
    public class InventoryTransactionEfCoreRepository : IInventoryTransactionRepository
    {
        ...
        void IInventoryTransactionRepository.ProduceAsync(string productionNumber, Inventory inventory, int quantityToConsume, string doneBy, double price)
        {
            throw new NotImplementedException();
        }

        void IInventoryTransactionRepository.PurchaseAsync(string poNumber, Inventory inventory, int quantity, string doneBy, double price)
        {
            throw new NotImplementedException();
        }
    }
